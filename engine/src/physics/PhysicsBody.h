...
namespace Freeze {
    ...
    namespace Physics {
        ...
        public:
            ...
            virtual void RenderBody(const glm::mat4& projectionMatrix, const glm::vec4& color) = 0;
        ...
        public:
            ...
            void RenderBody(const glm::mat4& projectionMatrix, const glm::vec4& color) override;
