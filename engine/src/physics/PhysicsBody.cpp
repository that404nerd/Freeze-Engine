  ...
  namespace Physics {
   ...
   std::vector<StaticBody::StaticBodyData*> StaticBody::m_StaticBodies;
    ...
    DynamicBody::DynamicBody()
      :m_BodyData(new DynamicBodyData()), m_Friction(0.0f), m_Density(0.0f), m_Restitution(0.0f)
    {
    }
    ...
    void StaticBody::RenderBody(const glm::mat4& projectionMatrix, const glm::vec4& color)
    {
