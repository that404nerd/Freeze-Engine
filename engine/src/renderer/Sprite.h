...
namespace Freeze {
  ...
  public:
    ...
    // @param size Can be zoomed or can be really small based on the orthographic projection specified using the Camera API's constructor
  ...
  private:
    std::shared_ptr<VertexBuffer> m_VertexBuffer = std::make_shared<VertexBuffer>();
